        ...
        <div class="bookmark">
            ...
            <div class="noticeTitle" v-if="ticketNotice">
                ...
                <div class="textArea">
                    ...
                    演唱會現場嚴禁攝錄影，禁止攜帶飲食(水除外)、除手機之外的任何形式之拍攝及錄音電子設備、自拍棒與危險物品（依主辦單位定義）入場，現場需經安檢程序方能入場，場館無設置置物櫃，開演前請關注票亮視界
                    官方網站
                    ...
                    請支持杜絕黃牛票以及二手票券買賣，台灣演出請上官方售票網站購票，請千萬不要購買非官方管道售出的票券。若因購買非官方售票網站售出的票券引起相關權益受損致無法入場，將無法保障自身權益，本售票系統恕不負責，主辦單位保留認定票券合法性之權力。<br>
                    ...
                    遺失票券：<br>
                    座位區遺失票券者，請盡早進線02-8772-9835或點選聯繫我們至票亮視界申告，遺失票券者需在演出當日下午6點前，持警局報案單、購票證明與身份證明文件前往場館票亮視界櫃臺簽立切結書，待開演後清查該座位無人進場，可讓申報遺失票券的消費者入場觀賞，但倘若持票人出現，應以持票人優先，遺失票券的觀眾需另行購票入場(剩餘票券，依現場實際狀況為準)，否則將觸及刑法第339條的詐欺不正取財之公訴罪。若雙方僵持不下，將會請出場外報警處理。
                </div>
            </div>
            ...
            <div class="buyNotice" v-if="buyNotice">
                <div class="textArea">
                    欲購票者，請參考【票亮視界會員加入辦法】，需進行手機驗證，才可開始購票，未完成驗證者，恕無法購票，建議提早完成。<br>
                    單筆訂單限購4張，可支援行動裝置購票。<br>
                    付款方式僅可選擇【信用卡付款】，且需在十分鐘內結帳完畢。<br><br>
            ...
            <div class="cencelTicket" v-if="cencelTicket">
                <div class="textArea">
                    根據文化部訂定『藝文表演票券定型化契約應記載及不得記載事項』第六項「退、換票機制」之規定共有四種方案之退換票規定，本節目採用方案二：<br><br>
                    
                    購票後(不含購票當日)三日內得退票，第四日起即不接受退票申請
                    <br><br>
                    電子票券退票方式：<br>
                    1.登入會員後，點選首頁上方的「訂單查詢」，點選欲退票或取消活動的「報名資料」，在報名資料中點選「取消訂單」 即可 。 <br>
                    2.以上步驟完成並點選「確認取消訂單」，電子票券退票自系統確認已銷毀票券後，方完成申請退票手續。<br>
                    3.請注意：電子票券退票僅能整筆訂單取消，恕無法單張退票。<br>
                    4.至以下連結填寫表單<br>
                    <br>
                    <a href="/">「【信用卡】 退票申請書 _ 未取票/電子票券」</a>
                </div>
            </div>
        </div>
    </div>
